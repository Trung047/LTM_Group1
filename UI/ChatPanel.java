...
/**
 * ChatPanel — Màn hình chat chính với:
 *   - Header (tên phòng, trạng thái kết nối, ping)
 *   - Khung chat (JTextPane với bubble HTML-like)
 *   - Sidebar danh sách người dùng (UserListPanel)
 *   - Input bar (JTextArea + Send button)
 */
public class ChatPanel extends JPanel {
    ...
    private JPanel buildHeader() {
        ...
        JPanel roomAvatar = new JPanel() {
            @Override protected void paintComponent(Graphics g) {
                ...
                GradientPaint gp = new GradientPaint(0, 0, DarkTheme.PRIMARY,
                                                     36, 36, DarkTheme.ACCENT);
                g2.setPaint(gp);
        ...
        right.add(lblPing);
        JButton btnDisconnect = DarkTheme.makeIconButton("✕ Ngắt kết nối", "Ngắt kết nối khỏi server");
        btnDisconnect.setForeground(DarkTheme.DANGER);
    ...
    private JPanel buildCenter() {
        ...
        chatScroll.setBackground(DarkTheme.BG);
        chatScroll.getViewport().setBackground(DarkTheme.BG);
        // Typing indicator + chat in a Y-axis panel
    ...
    private JPanel buildInputBar() {
        ...
        JButton sendBtn = new JButton() {
            ...
            @Override protected void paintComponent(Graphics g) {
                ...
                GradientPaint gp = new GradientPaint(
                        0, 0, hov ? DarkTheme.PRIMARY_DK : DarkTheme.PRIMARY,
        ...
        sendBtn.setToolTipText("Gửi tin nhắn (Enter)");
    ...
    public void appendMessage(String sender, String text, boolean isOwn) {
        ...
        String avatarHtml = "<div style='display:inline-block;"
    ...
    /** Thêm đường phân cách ngày */
    public void appendDivider(String label) {
        String html = "<div style='display:flex;align-items:center;"
    ...
    public void setOnlineUsers(List<String> users) {
        userListPanel.setOnlineUsers(users);
        lblOnlineStatus.setText("● " + users.size() + " thành viên đang online");
    }
    public void addOnlineUser(String name) {
        userListPanel.addOnlineUser(name);
    }
    public void removeOnlineUser(String name) {
        userListPanel.removeOnlineUser(name);
    }
    ...
    private void sendCurrentMessage() {
        ...
        if (chatListener != null) chatListener.onSendMessage(text);
        inputArea.setText("");
        inputArea.requestFocus();
    }
    ...
    private JLabel buildPingLabel() {
        ...
        l.setOpaque(true);
        l.setBackground(new Color(0x0891b2, true));
        l.setBorder(new DarkTheme.RoundBorder(
                new Color(0x06b6d4), 10, 3));
        return l;
    }
